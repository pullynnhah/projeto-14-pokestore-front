    ...
    <Wrapper>
      ...
      <Container>
        ...
        <EditForm onSubmit={handleForm}>
          ...
          <input type="number" name="Zip-code" placeholder="Zip-code" disabled={isDisable} />

          <input type="text" name="Adress" placeholder="Adress" disabled={isDisable} />

          <input type="number" name="Nº" placeholder="Nº" disabled={isDisable} />

          <input type="text" name="Neighborhood" placeholder="Neighborhood" disabled={isDisable} />

          <input type="text" name="City" placeholder="City" disabled={isDisable} />

          <input type="number" name="Contact" placeholder="Contact" disabled={isDisable} />
